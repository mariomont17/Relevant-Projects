...
set_property PACKAGE_PIN U9 [get_ports {sw_1_4[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_1_4[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {sw_1_4[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_1_4[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {sw_1_4[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_1_4[2]}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {sw_1_4[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_1_4[3]}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
set_property PACKAGE_PIN R5 [get_ports {sw_5_8[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_5_8[0]}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports {sw_5_8[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_5_8[1]}]
##Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
set_property PACKAGE_PIN V6 [get_ports {sw_5_8[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_5_8[2]}]
##Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
set_property PACKAGE_PIN V5 [get_ports {sw_5_8[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_5_8[3]}]
##Bank = 34, Pin name = IO_L8P_T1-34,						Sch name = SW8
set_property PACKAGE_PIN U4 [get_ports {sw_9_12[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_9_12[0]}]
##Bank = 34, Pin name = IO_L9N_T1_DQS_34,					Sch name = SW9
set_property PACKAGE_PIN V2 [get_ports {sw_9_12[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_9_12[1]}]
##Bank = 34, Pin name = IO_L9P_T1_DQS_34,					Sch name = SW10
set_property PACKAGE_PIN U2 [get_ports {sw_9_12[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_9_12[2]}]
##Bank = 34, Pin name = IO_L11N_T1_MRCC_34,					Sch name = SW11
set_property PACKAGE_PIN T3 [get_ports {sw_9_12[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_9_12[3]}]
##Bank = 34, Pin name = IO_L17N_T2_34,						Sch name = SW12
set_property PACKAGE_PIN T1 [get_ports {sw_13_16[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_13_16[0]}]
##Bank = 34, Pin name = IO_L11P_T1_SRCC_34,					Sch name = SW13
set_property PACKAGE_PIN R3 [get_ports {sw_13_16[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_13_16[1]}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
set_property PACKAGE_PIN P3 [get_ports {sw_13_16[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_13_16[2]}]
##Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
set_property PACKAGE_PIN P4 [get_ports {sw_13_16[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_13_16[3]}]
...
set_property PACKAGE_PIN L3 [get_ports {segments[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {segments[0]}]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {segments[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {segments[1]}]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {segments[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {segments[2]}]
##Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {segments[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {segments[3]}]
##Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
set_property PACKAGE_PIN K3 [get_ports {segments[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {segments[4]}]
##Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {segments[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {segments[5]}]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {segments[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {segments[6]}]

##Bank = 34, Pin name = IO_L16P_T2_34,						Sch name = DP
set_property PACKAGE_PIN M4 [get_ports segments[7]]							
...
set_property PACKAGE_PIN E16 [get_ports btn[1]]						
