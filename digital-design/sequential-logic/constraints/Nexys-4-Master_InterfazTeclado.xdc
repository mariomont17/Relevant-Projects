...
set_property PACKAGE_PIN T8 [get_ports {LED_Verif}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LED_Verif}]
...
#set_property PACKAGE_PIN P5 [get_ports {Bits[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {Bits[0]}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
#set_property PACKAGE_PIN U1 [get_ports {Bits[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {Bits[1]}]
##Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
#set_property PACKAGE_PIN R2 [get_ports {Bits[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {Bits[2]}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
#set_property PACKAGE_PIN P2 [get_ports {Bits[3]}]					
...
set_property PACKAGE_PIN B13 [get_ports {A}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {A}]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports {B}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {B}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
set_property PACKAGE_PIN D17 [get_ports {C1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {C1}]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
set_property PACKAGE_PIN E17 [get_ports {C0}]					
