...
set_property PACKAGE_PIN R3 [get_ports {addr_i}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {addr_i}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
#set_property PACKAGE_PIN P3 [get_ports {wr_i}]					
...
set_property PACKAGE_PIN T16 [get_ports wr_i]						
	set_property IOSTANDARD LVCMOS33 [get_ports wr_i]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
set_property PACKAGE_PIN R10 [get_ports rst_i]						
